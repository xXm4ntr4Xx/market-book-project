	...
	<!-- <form action="http://localhost:8080/market-book/UserRegistration"method="GET">
	 ...
	 <div class="flex items-center justify-center min-h-screen bg-gray-100 theBody">
       ...
       <!--  <div class="flex justify-center">
        ...
        <h3 class="text-2xl font-bold text-center">The BookStore</h3> 
        <form action="http://localhost:8080/market-book/UserRegistration" method="GET">
            <div class="mt-4">
                <div>
                    <label class="block" for="Name">Name</label>
                            <input type="text" placeholder="Name"
                                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"name="name"required>
                </div>
                <div>
                    <label class="block" for="Surname">Surname</label>
                            <input type="text" placeholder="Surname"
                                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"name="surname"required>
                </div>
                <div class="mt-4">
                ...
                <div class="flex">
                    <button class="w-full px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-900"type="submit" name="Submit">Create
                        Account</button>
                </div>
                <div class="mt-6 text-grey-dark">
                    Already have an account?
                    <a class="text-blue-600 hover:underline" href="Login.jsp">
                        Log in
                    </a>
                </div>
            </div>
