...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
 <div class="container flex flex-wrap justify-between items-center mx-auto">
  <a href="http://localhost:8080/market-book/WelcomePage.jsp" class="flex">
 ...
 <li><a href="Login.jsp"class="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white"aria-current="page">Login</a>
 </li>
 <li><a href="Register.jsp"class="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white"aria-current="page">NewCustomer</a>
 </li>
...
<div class="flex justify-center ">
 <form action="#" method="GET">
  <input type="submit" value="Basket" class="flex justify-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"/>
 </form>
</div>
	...
	<div class="flex justify-center ">
		<h2>Total Price:  </h2> <h1><c:out value="${basketTotal}"></c:out> </h1>
	</div>
