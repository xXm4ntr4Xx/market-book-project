...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 navigationBar">
 ...
 <li>
 	<a href="Register.jsp"class="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white"aria-current="page">NewCustomer</a>
 </li>
...
<!--show book  -->
<div class="flex justify-center pageBackground">
 <form action="http://localhost:8080/market-book/BookShow" method="GET">
  <input type="submit" value="Show Books" autofocus="autofocus"class="flex justify-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"/> 
 </form>
</div>
<br>
<br>
